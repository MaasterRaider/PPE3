...
import com.karimandco.admin.bdd.DaoSIO;
import java.awt.Color;
import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;
import com.karimandco.admin.BDD;
...
public class PanneauFormConnexion extends javax.swing.JPanel {
    ...
    Connexion panneauPereConnexion = null;
    ...
    public Connexion getPanneauPereConnexion() {
        return panneauPereConnexion;
    }

    public void setPanneauPereConnexion(Connexion panneauPereConnexion) {
        this.panneauPereConnexion = panneauPereConnexion;
    }

    public BDD getConnexionBDD() {
        return connexionBDD;
    }

    public void setConnexionBDD(BDD connexionBDD) {
