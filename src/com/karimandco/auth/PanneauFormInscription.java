...
public class PanneauFormInscription extends javax.swing.JPanel {
    ...
    Inscription panneauPereInscription = null;
    ...
    public void setFenParentInscription(Inscription i) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (nomOK && prenomOK && identifiantOK && courrielOK && numeroTelephoneOK && dateNaissanceOK && mdpOK) {
            ...
            if (DaoSIO.getInstance().requeteAction("INSERT INTO utilisateurs (nom, prenom, identifiant, courriel, num_telephone, date_de_naissance, mot_de_passe, photo) VALUES ('" + this.panneauNom.getChamp2().getText() + "', '" + this.panneauPrenom.getChamp2().getText() + "', '" + this.panneauIdentifiant.getChamp2().getText() + "', '" + this.panneauCourriel.getChamp2().getText() + "', '" + this.panneauNumeroTelephone.getChamp2().getText() + "', '" + date_newFormat + "', '" + String.valueOf(this.panneauMdp.getChampSecret1().getPassword()) + "', '')") > 0) {
                panneauPereInscription.getObjAutreFenetreAdmin().getjLabelEtatVider().setForeground(Color.blue);
                panneauPereInscription.getObjAutreFenetreAdmin().getjLabelEtatVider().setText("Inscription réussie");
                panneauPereInscription.getObjAutreFenetreAdmin().updateJTableInfo();
                panneauPereInscription.getObjAutreFenetreAdmin().cInscription.setVisible(false);

            } else {
                panneauPereInscription.getObjAutreFenetreAdmin().getjLabelEtatVider().setForeground(Color.red);
                panneauPereInscription.getObjAutreFenetreAdmin().getjLabelEtatVider().setText("Echec de l'inscription");
            }
        } else {
            panneauPereInscription.getObjAutreFenetreAdmin().getjLabelEtatVider().setForeground(Color.black);
            panneauPereInscription.getObjAutreFenetreAdmin().getjLabelEtatVider().setText("");
        }
