...
public class PanneauAdministration extends javax.swing.JPanel {
    ...
    public com.karimandco.admin.ConnexionAdmin cConnexionAdmin;
    ...
    private void jButtonSuppToutUtilisateursActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSuppToutUtilisateursActionPerformed
        cConnexionAdmin = new ConnexionAdmin(this);
        cConnexionAdmin.getPanneauFormConnexionAdmin1().getjLabel1().setText("Connexion administration");
        cConnexionAdmin.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        cConnexionAdmin.getPanneauFormConnexionAdmin1().getjButtonConnexion().addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (cConnexionAdmin.getPanneauFormConnexionAdmin1().getEstConnecte() == true) {
                    Boolean Supp = false;
    ...
    private void jButtonSuppUtilisateurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSuppUtilisateurActionPerformed
        ...
        if (idTable < 0) {
            ...
            cConnexionAdmin.getPanneauFormConnexionAdmin1().getjButtonConnexion().addMouseListener(new MouseListener() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    if (cConnexionAdmin.getPanneauFormConnexionAdmin1().getEstConnecte() == false) {
                        Boolean Supp = false;
                        cConnexionAdmin.setVisible(false);
                        //Creation de la variable boolean Supp étant fausse
                        TableModel test = jTableInfo.getModel();
                        ...
                        if (option == JOptionPane.OK_OPTION) {
                            ...
                            try {
                                ...
                                if (helpers.supprimeToutCV(id_admin) && DaoSIO.getInstance().requeteAction("DELETE FROM utilisateurs WHERE statut = 0 AND id = '" + id_admin + "'") == 1 && Supp == true) {
                                    jLabelEtatVider.setForeground(Color.blue);
