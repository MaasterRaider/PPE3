...
public class PanneauFormModification extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (nomOK && prenomOK && identifiantOK && courrielOK && numeroTelephoneOK && dateNaissanceOK) {
            ...
            Boolean resultat = connexionBDD.InsertFormUpdate(this.getIdentifiant_utilisateur(), this.panneauNom.getChamp2().getText(), this.panneauPrenom.getChamp2().getText(), this.panneauIdentifiant.getChamp2().getText(), this.panneauCourriel.getChamp2().getText(), this.panneauNumeroTelephone.getChamp2().getText(), date_newFormat);
            if (resultat == true) {
                ...
                panneauPereModification.getObjAutreFenetreAdmin().getjLabelEtatVider().setText("Echec de l'inscription");
            }
        } else {
